...
public class NoticeFileHandler {
    ...
    public NoticeFileHandler(PhotoService photoService) {
        this.photoService = photoService;
    }

    public List<NoticePhoto> parseFileInfo(
    	List<MultipartFile> multipartFiles
    )throws Exception {
  	// 반환할 파일 리스트
        List<NoticePhoto> fileList = new ArrayList<>();
	...
	// 전달되어 온 파일이 존재할 경우
        if(!CollectionUtils.isEmpty(multipartFiles)) { 
            ...
            // 파일을 저장할 세부 경로 지정
            String path = "images/notice" + File.separator + current_date;
            ...
            for(MultipartFile multipartFile : multipartFiles) {
                    ...
                    NoticePhoto photo = new NoticePhoto(
